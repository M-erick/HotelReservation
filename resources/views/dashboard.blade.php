...
<style>
    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-200 antialiased">
                <div class="flex flex-col shadow-xl bg-white overflow-scroll"  style="width:411px;height:823px">
            <div class="flex flex-col">
                <img class="sticky" src="https://i.ibb.co/B66k7GC/status-bar-hero-iphone-61-portrait-black-2x.png" alt="">
                <div class="bg-white rounded-full p-1 shadow-md border-gray-200 border items-center justify-between flex flex-row mx-5 mt-5">
                    <div class="p-2 rounded-full text-black">
                      ...
                      <div>
                        ...
                        <p class="text-gray-800 text-xxsm">Anywhere Any week Add guests</p>
                      </div>
                ...
                <div class="mx-5 mt-5">
                    <img class="rounded-lg bg-cover" src="https://images.unsplash.com/photo-1568605114967-8130f3a36994?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2940&q=80" alt="">
                ...
                <div class="mx-5 mt-5">
                    <img class="rounded-lg bg-cover" src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2950&q=80" alt="">
                    <div class="flex flex-row justify-between items-start mt-4">
                        <div>
                            <p class="text-sm text-gray-800 font-bold">Brienno, Italy</p>
                            <p class="text-sm text-gray-800">49 kilometers away</p>
